...
public class DetailEntreeService implements DetailEntreeServiceImplementation {
	...
	@Override
	public DetailEntree create(Double prixUnitaire, Integer quantite, String filePathBand, Long articleId) {
	...
	@Override
	public DetailEntree update(Long id, Integer quantite, String filePathBand, Long entreeId, Long articleId) {
